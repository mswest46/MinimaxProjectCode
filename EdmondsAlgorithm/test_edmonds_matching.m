...
new_pair = edmonds_matching(adjacency_matrix, pair);
assert(isequal(pair,new_pair));
...
pair = edmonds_matching(adjacency_matrix,[]);
...
for i = 1:4
    ...
    pair2 = edmonds_matching(adjacency_matrix,'');
